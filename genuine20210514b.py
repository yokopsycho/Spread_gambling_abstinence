...
for k, v in nx.degree_centrality(pigg).items():
    ...
    thnocentlb=[]
    for nd1 in nodes1:
        legend_l.append(legendtimedic[nd1])
        user_l.append(usertimedic[nd1])
    ...
    e2thnocentlb=[]
    for e2 in edges2b:
        e2legendfrom_l.append(legendtimedic[e2[0]])
        e2usernamefrom_l.append(e2[0])
        username2_l.append(e2[1])
        e2legend_l.append(legendtimedic[e2[1]])
        e2user_l.append(usertimedic[e2[1]])
    ...
    for i in range(len(e2legend_l)):
        ...
        if fromusername2 not in talkname_lb:
            #print("nonusername2")
            continue
        usertime2 = usertimedic[fromusername2]
        ...
        if fromusername2 not in legendname_lb:
            continue
        legendtime2 = legendtimedic[fromusername2]
    ...
    e3thnocentlb=[]
    for e3 in edges3b:
        e3legendfrom_l.append(legendtimedic[e3[0]])
        e3usernamefrom_l.append(e3[0])
        e3legend_l.append(legendtimedic[e3[1]])
        e3user_l.append(usertimedic[e3[1]])
    ...
    for i in range(len(e3legend_l)):
        ...
        if fromusername3 not in talkname2_lb:
            continue
        usertime3 = usertimedic[fromusername3]
        ...
        if fromusername3 not in legendname2_lb:
            continue
        legendtime3 = legendtimedic[fromusername3]
